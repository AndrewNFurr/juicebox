...
usersRouter.post('/login', async (req, res, next) => {
  ...
  try {
    ...
    if (user && user.password == password) {
      ...
      res.send({ message: "you're logged in!" , token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidXNlcm5hbWUiOiJhbGJlcnQiLCJpYXQiOjE2MDc2NTQzNTR9.p-RxeCLsZlUncNqNlKdProbc68gvNSTeucy9UwjO8CE"});
    } else {
      next({ 
